...
<div class="tintedbg">
    <form name="HouseInfoForm" method="post" action="LAcreateRoomDetailsServlet" action="AddImagesServlet"  enctype = "multipart/form-data">
        <br/>
        <br/>
        <div class="input-box">
            <div class="col">
        ...
        <div class="file-upload-wrapper col-md">
            <label for="hPic">Room Image :</label>
