...
<sql:query dataSource="${ic}" var="oc">
    ...
    SELECT H.HOUSEPUBLISHDATE,H.HOUSENAME,H.HOUSEMONTHLYPRICE,H.HOUSEADDRESS,H.HOUSELOCATION,H.HOUSEAVAILIBILITY,H.HOUSENOTENANTS,H.HOUSENOROOM,H.HOUSENOTOILET,H.HOUSENOAC,H.HOUSEWIFI,H.HOUSEFURNITURE,H.HOUSEWM,H.HOUSEDESCRIPTION,H.HOUSEPICNAME,H.HOUSEID,H.LANDLORDID
    FROM HOUSEDETAILSS
    WHERE HOUSEID=?
